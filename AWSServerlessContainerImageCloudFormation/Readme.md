...
WORKDIR /src
COPY ["AWSServerlessContainerImageCloudFormation.csproj", "AWSServerlessContainerImageCloudFormation/"]
RUN dotnet restore "AWSServerlessContainerImageCloudFormation/AWSServerlessContainerImageCloudFormation.csproj"

WORKDIR "/src/AWSServerlessContainerImageCloudFormation"
COPY . .
RUN dotnet build "AWSServerlessContainerImageCloudFormation.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AWSServerlessContainerImageCloudFormation.csproj" \
...
Execute unit tests
```
    cd "AWSServerlessContainerImageCloudFormation/test/AWSServerlessContainerImageCloudFormation.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerlessContainerImageCloudFormation/src/AWSServerlessContainerImageCloudFormation"
